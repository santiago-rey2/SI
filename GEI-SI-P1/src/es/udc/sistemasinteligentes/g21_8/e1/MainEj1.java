...
import es.udc.sistemasinteligentes.g21_8.ejemplo.ProblemaAspiradora;

public class MainEj1 {

    public static void main(String[] args) throws Exception {
        es.udc.sistemasinteligentes.g21_8.ejemplo.ProblemaAspiradora.EstadoAspiradora estadoInicial = new es.udc.sistemasinteligentes.g21_8.ejemplo.ProblemaAspiradora.EstadoAspiradora(es.udc.sistemasinteligentes.g21_8.ejemplo.ProblemaAspiradora.EstadoAspiradora.PosicionRobot.IZQ,
                                                                                                    es.udc.sistemasinteligentes.g21_8.ejemplo.ProblemaAspiradora.EstadoAspiradora.PosicionBasura.AMBAS);
